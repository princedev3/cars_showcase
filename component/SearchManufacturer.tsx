...
const SearchManufacturer = ({manufacturer,setManufacturer}:ManufacturerProps) => {
    ...
    const filterManufacturers = query === ""?manufacturers :manufacturers.filter(item=>item.toLocaleLowerCase().replace(/\s+/g,"").includes(query.toLocaleLowerCase().replace(/\s+/g,"")))
