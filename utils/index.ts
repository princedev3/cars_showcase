...
export async function fetchCars(filter:FilterProp) {
  const {manufacturer,model,limit,fuel,year}=filter
    const headers= {
		'X-RapidAPI-Key': '88a31a31c6msh4a31f0ff1ffbab1p16a29cjsne35c1d5ac818',
...
export const calculateCarRent = (city_mpg: number, year: number) => {
  ...
  export const updatenewSearchParam =(type:string,value:string)=>{
